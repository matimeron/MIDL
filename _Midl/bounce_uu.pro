Pro Bounce_uu, angran, step= stp, crystal= crs, index= find, sindex= sind, $
	...
	if exs then begin
		...
		anfac = 1/(asiz*sqrt(1/asiz^2 + 1/wfdar^2 + 1/wsdar^2))
		...
		ftit = crnam + string(find,form='("(",3i1,")+")') + $
		crnam + string(sind,form='("(",3i1,") up bounce")')
