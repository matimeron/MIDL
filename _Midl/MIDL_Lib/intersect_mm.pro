Function Intersect_mm, far, sar, digits = dig, dec_digits = dec, netlen= nl, $
	_extra= _e
...
;		Modified 20-OCT-2016 by Mati Meron.  Internal changes.
;-
	...
	res = [wfar,wsar]
	if res ne !null then res = res[Sorspec(res,/comp,net=nl)] else nl = 0l
