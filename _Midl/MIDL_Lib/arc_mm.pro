Pro Arc_mm, r1, r2, center = cent, radius = rad, angle = ang, degrees = deg, $
...
;		Mode 1:
;			ARC_MM, R1, CENTER = CENT, ANGLE = ANG [, optional keywords]
...
;		Mode 2:
;			ARC_MM, R1, R2, {RADIUS = RAD, ANGLE = ANG} [, optional keywords]
...
;		Created 15-DEC-1991 by Mati Meron, as ARC.
...
;		Renamed ARC_MM 25-AUG-2010 by Mati Meron.
;-
