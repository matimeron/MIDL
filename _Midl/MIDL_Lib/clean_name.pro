Function Clean_name, name, wild = wld, keep_space = kps
...
;	/KEEP_SPACE
;		Switch.  If set, all whitespace is reduced to a single space.  By 
;		default whitespace is removed.
; OUTPUTS:
;		Returns the original string, with blank spaces removed, with all
;		Hershey codes (of the form '! ') replaced with comas and with all
...
;		Modified 5-NOV-2013 by Mati Meron.  Added keyword KEEP_SPACE.
;-
	...
	res = strcompress(name,rem=1-keyword_set(kps))
