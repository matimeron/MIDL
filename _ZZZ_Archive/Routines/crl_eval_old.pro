Pro CRL_eval_old, energy = ene, rsig = rsg, asig = asg, und_length = udl, $
...
;		PQR_PROP from OPTICS. Calls ARREQ, CAST, DEFAULT, ERRORF_MM, HOW_MANY,
;		IMAGINARY_MM, ISNUM, LABELS, MAKE_GRID, NULLIFY, ONE_OF, PLVAR_KEEP,
;		REAL_MM, STREQ, TOLER and TYPE, from MIDL.
