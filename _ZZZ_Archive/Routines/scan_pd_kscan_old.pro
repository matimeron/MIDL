Function Scan_PD_Kscan_old, snum, fnum, verify = ver, $
...
;		SCAN_PD_FRAMES, SCAN_PD_FPREAD, SCAN_SHOW and SPEC_FILE_CHECK.  Calls
;		ERREST from SURF_LIB.  Also calls DEFAULT, FPU_FIX, HOW_MANY and ISNUM 
;		from MIDL.
