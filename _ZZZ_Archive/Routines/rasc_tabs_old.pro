Function Rasc_tabs_old, filnam, header = hed, _extra = _e
...
;		RASC_TABS calls RASCLINE and STRPARSE_MM, from MIDL.
...
;-
	...
	dum = Rascline(filnam,lines=lin,count=con,stat=sta,_extra=_e)
	if sta then begin
