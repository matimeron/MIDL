Pro PD_sum_old, snum, fnum, warn_only = won, orientation= ori, $
...
;		SCAN_PD_READ and SCAN_PD_SHOW.  Calls DEFAULT, ISNUM, RANGE_COMP and
...
;-
	...
	if keyword_set(cmr) then begin
		if nsc eq 1 then begin
			...
			wcen = Scan_PD_cencoo(snum,wfnum[0],raw=raw,ang=ang)
