Pro PD_XR_view_old, snum, fnum, verify = ver, sum = sum, slit= sli, back_ang= bag,$
...
;		SCAN_PD_CENLOC, SCAN_PD_CENTER, SCAN_PD_FRAMES, SCAN_PD_SHOW and 
;		SPEC_FILE_CHECK.  Also calls DEFAULT, ISNUM and WHERINSTRUCT from MIDL.
