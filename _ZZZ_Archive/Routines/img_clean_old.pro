Function Img_clean_old, id_0, id_1, id_2, id_3, id_4, id_5, id_6, id_7, $
	coeffs = cof, extrapolate = ext, positive = pos
...
;		IMG_LC for the actual subtraction.  Also calls NPARDEF, from MIDL. 
