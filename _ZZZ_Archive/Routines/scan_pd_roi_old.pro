Function Scan_PD_roi_old, snum, fnum, $
...
; 		SCAN_PD_FRAMES, SCAN_PD_READ, SCAN_PD_SHOW and SCAN_SHOW.  Calls ERREST
; 		from SURF_LIB.  Also calls ARREQ, DEFAULT, FPU_FIX and ISNUM, from MIDL.
