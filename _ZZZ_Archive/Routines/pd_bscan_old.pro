Pro PD_Bscan_old, snum, fnum, slit = sli, back_ang = bag, tilt = tau, $
...
;		SCAN_PD_READ, SCAN_SHOW and SPEC_FILE_CHECK.  Calls QVEC from SURF_LIB.
;		Also calls DEFAULT, HOW_MANY, ISNUM, MAKE_GRID, ONE_OF and RANGE_COMP, 
;		from MIDL.
...
;-
	...
	dct = cent[0]
	wtol = Default(tol,6*(cur.pdstat - 2),/dtyp)
