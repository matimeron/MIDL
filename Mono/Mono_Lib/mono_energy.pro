Function Mono_energy, tet, crystal = crs, index = ind, asym_angle = asym, $
	radians = rad, degrees = deg, uncorrected = unc, $
	wavelength = lamb, delta_e = dee, _extra = _e
...
;-
	...
	qzop = Qval(crys=crs,ind=ind,dref=dref,/transmit,_extra=_e)/!pi
