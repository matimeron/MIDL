...
;		Modified 1-NOV-2014 by Mati Meron.  Added fields.
;-

	on_error, 1

	dum = {user, $
		expid: 0l, date: '', badge: 0l, fname: '', lname: '', $
		ustyp: '', gender: '', instit: '', insrol: '', $
		orgtyp: '', fund: '', spoksp: '', $
		discip: '', tech: '', pen: '', $
		station: '', month: 0l, day: 0l, year: 0l, run: 0l}
