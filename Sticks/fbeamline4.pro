Pro Fbeamline4, bor = bor
	...
	foe = Shape_close([[24.5,-0.2],[27.8,-0.55],[31.3,-0.55],[40.7,-1.4],$
		[40.7,2.1],[36,2.1],[26.5,2.1],[26.5,0.85],[24.5,0.85]])
	...
	plots, [[37.2,2.1],[39.2,2.1]], thi=2, col=!pcol.white
	plots, [[36.2,2.2],[37.2,2.2]], thi=2, col=!pcol.green
	plots, [[39.2,2.2],[40.2,2.2]], thi=2, col=!pcol.green
...
;	Rectan, xli=0.7*[-1,1], yli=0.42*[-1,1], /no_show, shape=mirror
	...
	shutter2 = Shape_trans(shutter,0,1,40*inb+vof)
	crl1 = Shape_trans(crl,0,1,46*oub)
	crl2 = Shape_trans(crl,0,1,36.*inb+vof)
	...
	Labels, [32.5,40.,36.],off + [0.4,0.4,0.4],align=0.5,$
