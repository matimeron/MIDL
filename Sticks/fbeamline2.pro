Pro Fbeamline2, bor = bor
	...
	plots,[28.5,28.5]##inb + mof01, thi=2, col=!pcol.purple, line=2
	plots,[28.5,33.5]##inb + mof01, thi=2, col=!pcol.purple, line=2
...
;	Rectan, xli=1.5*[-1,1], yli=0.42*[-1,1], /no_show, shape=mirror
	...
	mono = Shape_trans(mono,0,1,32*oub-[0,0.05])
	mirror = Shape_trans(mirror,0,1,35.5*oub)
	scr1 = Shape_trans(scr,0,1,28.5*inb)
	sbm = Shape_trans(sbm,0,1,31*inb+vof)
	...
	Labels, [32,35.5,47.5,46],[-1.3,-1.4,-0.6,-0.6],align=0.5,$
		['Mono','Mirrors','Shut.','CRL'],charsize=1.6,col=!pcol.pink
	Labels, [30.9,36.8,35.4],off + [0.4,0.4,0.4],align=0.5,$
