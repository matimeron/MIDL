Function DCD_temp, ene, chi, length = len, degrees = deg, radians = rad
	...
	v0 = [0,1,0]
	v1 = [sin(2*phi1),cos(2*phi1),0]
	v2 = [-sin(2*(phi2-phi1)),cos(2*(phi2-phi1)),0]

	n1 = [cos(phi1),-sin(phi1),0]
	n2 = [-cos(2*phi1-phi2),sin(2*phi1-phi2),0]
	n3 = [sin(wchi),0,cos(wchi)]
