Function Scan_PD_lcoo, snum, fnum, direction = dir, center = cnt, angle = ang, $
...
;		Modified 20-JUL-2014 by Mati Meron.  Added keyword PINHOLE.
...
;-
	...
	else if Default(pnh,angs[2] gt 1,/dtyp) then pdist = cur.pdsdist
