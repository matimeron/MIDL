Function Scan_PD_difmap, snum, fnum, verify = ver, inspect = ins, sum = sum, $
...
;		SCAN_PD_SHOW, SCAN_Q_ANGS, SCAN_PD_TOL and SPEC_FILE_CHECK.  Calls
;		PD_XR_VIEW from PD.  Calls ERREST from SURF_LIB.  Also calls DEFAULT,
;		FPU_FIX, HOW_MANY, ISNUM, MAKE_GRID, RANGE_COMP, RANGE_PROC, STREQ,
;		STRPARSE_MM and WHERINSTRUCT, from MIDL.
