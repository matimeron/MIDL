Function Scan_MCAO_read, snum, bin = bin, $
...
;		SPEC Input/Output.
; CALLING SEQUENCE:
;		Result = SCAN_MCAO_READ( SNUM [, keywords])
; INPUTS:
;	SNUM
...
;		Renamed SCAN_MCAO_READ (from the previous SCAN_MCA_READ) to make room 
;		for a new and different routine with this name.
