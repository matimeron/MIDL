Function Peak_skew, x, y, ser, error = err, ret_range = ret, _extra = _e
...
;		4.9
; PURPOSE:
;       Calculating the skewness of a peak.
; CATEGORY:
;       Data analysis.
; CALLING SEQUENCE:
;       Result = PEAK_SKEW ( X [, Y] [, SER] [, keywords])
; INPUTS:
;	X
...
; OUTPUTS:
;		Returns the skewness-value of a peak.
; OPTIONAL OUTPUT PARAMETERS:
;	ERROR
;		Returns the calculated statistical error of the skewness.
;	RET_RANGE
...
;-
	...
	res = Peak_scamom(sxy,ord=3,error=err)
