Function Zsorc, bsec, loc, internal = idum, relative = rdum
...
;		4.2
; PURPOSE:
;		Calculates virtual source location for a beam.
; CATEGORY:
;		Optics calculation.
; CALLING SEQUENCE:
;		Result = ZSORC( BSEC, LOC)
; INPUTS:
;	BSEC
...
;	LOC
;		Current location along the beam path.
...
;		Switch.  "Consistency" keyword, does nothing.
; OUTPUTS:
;		Returns the "current" source location for the beam, in meters. If BSEC
