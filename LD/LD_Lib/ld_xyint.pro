Pro LD_xyint, sl_0, sl_1, sl_2, sl_3, sl_4, sl_5, sl_6, sl_7, $
 	xy_reg = xyr, z_reg = zr, title = tit, log = log, angles = ang, bare = bar,$
 	flip = fli, result = res, _extra = _e
...
;		Modified 20-JUN-2006 by Mati Meron.  Added keywords /BARE and /FLIP.
;-

	on_error, 1

	res = LD_int(sl_0, sl_1, sl_2, sl_3, sl_4, sl_5, sl_6, sl_7, $
	xy_reg=xyr,z_reg=zr,/xy_int,xy_ran=wxy,z_ran=wz,angl=ang,tit=gtit,_extra=_e)
