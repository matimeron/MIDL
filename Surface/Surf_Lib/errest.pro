Function Errest, dat, emode = emd, squared = sqr, total = tot
...
; KEYWORD PARAMETERS:
;	/EMODE
;		Switch.  If set, or provided as *odd integer*, error is calculated for
;		"product of Poissonians", i.e. for the APEX detector.  If provided as
;		even integer, "single Poissonian" square-root error is calculated.
;	/SQUARED
...
;		None.
; PROCEDURE:
;		Straightforward.  Calls DEFAULT and FPU_FIX from MIDL.
; MODIFICATION HISTORY:
;		Created 25-MAR-2011 by Mati Meron.
;		Modified 25-AUG-2016 by Mati Meron.  Generalized the meaning of EMODE.
;-
	...
	if Default(emd,0,/dtyp) then res= idu*dat*(1+ epf+ dat/(idu*epf)) $
	else res= dat
