Pro PD_walk, snum, fnum, width = wid, filter = fil, $
...
;		SCAN_FIND, SCAN_LC, SCAN_PD_CENTER, SCAN_PD_FPREAD, SCAN_PD_TOL,
;		SCAN_SCALE and SCAN_SHOW.  Calls ERREST from SURF_LIB.  Calls ARRO,
;		CAST, DEFAULT, ISNUM, LEGEND_MM, LINFIT_MM, POLEVAL, PSYMS and SPLIT_XY,
;		from MIDL.
...
;-
	...
	hwid = Scan_PD_tol(wid,pdstat=cur.pdstat,base=6)
