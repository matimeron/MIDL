Function PD_GID_read, snum, frame = fnum, progress = prg, verify = ver, $
...
;		Modified 1-NOV-2015 by Mati Meron.  Slight internal changes.
;-
	...
	if keyword_set(byp) then begin
		...
		if keyword_set(raw) then begin
			...
			tdat = Img_trig(dat,qxy,qz,xuse=qxyref,xtr=tqxy,ytr=tqz,min=tight)
