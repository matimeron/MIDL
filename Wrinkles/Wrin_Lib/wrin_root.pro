Function Wrin_root, alp, kl, eps = eps, stat = sts, _extra = _e
...
;		Alpha must be >= 1.
; PROCEDURE:
;		Calls (indirectly) WRIN_DET, as well as DEFAULT, ROOT and TOLER from
;		MIDL.
; MODIFICATION HISTORY:
;		Created 10-DEC-2007 by Mati Meron.
;		Modified 5-May-2014 by Mati Meron.  Changed from EROOT to ROOT, 
...
;-
	...
	res = Root('wrin_det',walp,weps,par=kl,multi=-1,stat=sts,_extra=_e)
